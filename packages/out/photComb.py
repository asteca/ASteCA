...
def main(pd, clp):
    """
    Combine the photometry of the stars in the cluster and field regions
    ...
    clp.update({
        ...
        'col_0_comb': col_0_comb, 'col_1_comb': col_1_comb})
    return clp


def field_region_stars(field_regions, colors):
    """
