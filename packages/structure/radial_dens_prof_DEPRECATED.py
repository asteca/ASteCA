...
def main(clp):
    ...
    Several methods were developed over time.
    """

    # DEPRECATED 11/19
    # # Circular rings
    # rdp_radii, rdp_points, poisson_error = circRingsRDP(
    #     x, y, clp['kde_cent'])
    # # Square rings
...
# def kdeRDP(x, y, kde_cent, N_tot=250000):
#     """
...
#     kde = gaussian_kde(ds)
#     # This auto value seems to be in the range (.15, .25)
