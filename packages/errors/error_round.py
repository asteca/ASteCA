...
def round_to_ref(x, y):
    ...
    # If the returned value is 0., round it using 1 significant figure.
    if x_r == 0.:
        x_r = round_to_y(x)
...
def round_sig_fig(params, errors):
    ...
    for i, p in enumerate(params):
        if errors_r[i] > 0.:
            ...
            # If no error was assigned (i.e.: errors_r[i]=-1), don't attempt
...
#     params = [0., 0.01, 0.0001, 420.23, 31.561]
#     errors = [0.23, 0.121, 0.05, 1503.3, 0.04]
#     print round_sig_fig(params, errors)
